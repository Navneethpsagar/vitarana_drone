...
if __name__ == '__main__':
   try:
    ...
    setpoint=[[init_coord[0],init_coord[1],height],[final_setpoint[0],init_coord[1],height],[final_setpoint[0],final_setpoint[1],final_setpoint[2]]]
    while not rospy.is_shutdown():
        while val<3:
            if val==0 :
                errors = e_drone.pid(setpoint[0])
